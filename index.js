...
client.on(Events.MessageCreate, async (message) => {
    ...
    console.log("Correct channel detected");
...
client.on(Events.MessageCreate, async (message) => {
    ...
    console.log("EXPECTED:", config.applicationChannelId);
    ...
    const nameMatch =
        message.content.match(/name\s*:\s*(.+)/i);

    const steamMatch =
        message.content.match(/steam\s*link\s*:\s*(.+)/i);

    console.log("NAME MATCH:", nameMatch);
    console.log("STEAM MATCH:", steamMatch);
});
