...
Account Created:
${user?.createdAt ? `<t:${Math.floor(user.createdAt.getTime()/1000)}:F>` : "Unknown"}

Account Age:
${user?.createdAt ? `${Math.floor((Date.now()-user.createdAt)/86400000)} days` : "Unknown"}`
            },
...
${description}`
        ...
        .setFooter({
            text: "Advanced Discord Logging System"
        })
